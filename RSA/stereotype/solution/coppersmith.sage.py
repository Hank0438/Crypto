...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_512 = Integer(512); _sage_const_8 = Integer(8); _sage_const_3 = Integer(3); _sage_const_6299048417279759143921216936145685207119975383042483190059116449113455659191975086830406403008379957696510982986255467305795861932264261829072347486411957 = Integer(6299048417279759143921216936145685207119975383042483190059116449113455659191975086830406403008379957696510982986255467305795861932264261829072347486411957); _sage_const_504938538457279914401038579773558095109119666602719883760976245104121271313224075953255412936118480700680839162044623291082020919648790652113808351316973 = Integer(504938538457279914401038579773558095109119666602719883760976245104121271313224075953255412936118480700680839162044623291082020919648790652113808351316973); _sage_const_64 = Integer(64); _sage_const_7 = Integer(7); _sage_const_1024 = Integer(1024); _sage_const_200 = Integer(200); _sage_const_0p5 = RealNumber('0.5')
...
length_N = _sage_const_512   # size of the modulus
Kbits = _sage_const_8     # size of the root
e = _sage_const_3 

# RSA gen (for the demo)
N = _sage_const_6299048417279759143921216936145685207119975383042483190059116449113455659191975086830406403008379957696510982986255467305795861932264261829072347486411957 
e = _sage_const_3 
C = _sage_const_504938538457279914401038579773558095109119666602719883760976245104121271313224075953255412936118480700680839162044623291082020919648790652113808351316973 
M = int.from_bytes(b"Welcome to Crypto CTF! Your PIN code is \x00\x00\x00\x00".rjust(_sage_const_64 , b"\xff"), byteorder='big')
M = list(("{0:b}".format(M)))[::-_sage_const_1 ]
print(len(M))
print("M:", M)
input("@")
