...
Kbits = 8    # size of the root
e = 3

# RSA gen (for the demo)
N = 6299048417279759143921216936145685207119975383042483190059116449113455659191975086830406403008379957696510982986255467305795861932264261829072347486411957
e = 3
C = 504938538457279914401038579773558095109119666602719883760976245104121271313224075953255412936118480700680839162044623291082020919648790652113808351316973
M = int.from_bytes(b"Welcome to Crypto CTF! Your PIN code is \x00\x00\x00\x00".rjust(64, b"\xff"), byteorder='big')
M = list(("{0:b}".format(M)))[::-1]
print(len(M))
print("M:", M)
input("@")
